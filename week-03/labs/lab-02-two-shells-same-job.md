...
```
agent@storeroom-lnx01:/home/agent/archive/incident-42$ cd archive/incident-42
```
...
```
CMD:agent@storeroom-lnx01:/home/agent/archive/incident-42$ ls
...
```
CMD: PS /home/agent/archive/incident-42> ls
Output:
Mode                 Name
-a----               access-log.txt
...
| 2. Look around | ls | Get-ChildItem or ls |
| 3. Move into a folder | cd | Set-Location |
| 4. Peek inside a file | cat | Get-Content |
| 5. Create + back up your note | touch and cp  | New-Item and Copy-Item |
...
```
I feel comfortable using pwd vs. Get-Location interchangeably. Pwd is more convenient because it can be used for Bash as well as PowerShell, and it's shorter, as well as the case sensitivity of Get-Location. I typically use the ls command over dir and the cat command over type. I typically lean towards the commands that require less typing.
```
