...
```
PS /home/morgan> Get-Content logs/shift-log.txt
...
```
Get-Help <cmdlet> - displays a short description for the named cmdlet.
Get-Help provides information regarding the referenced command
```
